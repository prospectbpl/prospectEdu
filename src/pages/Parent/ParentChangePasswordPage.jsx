...
export default function ParentChangePasswordPage() {
  ...
  return (
    <div className="flex h-screen bg-[#F9FAFB] overflow-hidden">
      ...
      <Helmet>
        <title>Change Password | Parent Dashboard | ProspectEdu</title>
        <meta
          name="description"
          content="Change your parent account password securely in the ProspectEdu parent dashboard."
        />
      ...
      />
        ...
        {/* Body */}
        <main className="flex-1 overflow-y-auto px-1 py-10" style={{ marginTop: "50px" }}>
          <ChangePasswordForm />
        </main>
      </div>
    </div>
