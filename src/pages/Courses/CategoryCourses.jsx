...
export default function CategoryCourses() {
  ...
  const canonicalUrl = `${SITE_URL}/courses/category/${encodeURIComponent(category || "")}`;

  const pageTitle = `${(category || "Category").toString()} Courses | ProspectEdu`;
  const pageDescription = `Browse ${(category || "category").toString()} courses on ProspectEdu. Explore curated courses, pricing, start dates, and enroll online.`;
  ...
  }, [courses, SITE_URL, canonicalUrl, pageTitle, pageDescription]);
    ...
    <>
      ...
      <section className="py-16 bg-[#F9FAFB]">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-3xl font-heading text-[#124734] mb-6 text-center capitalize">
            {category} Courses
          </h1>
